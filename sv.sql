...
--
-- Host: localhost
-- Generation Time: Apr 01, 2013 at 10:44 AM
...
INSERT INTO `xsales` (`id`, `plot_id`, `agent_id`, `customer_id`, `RatePerSqUnit`, `salespolicy_name`, `down_payment`, `total_cost`, `emi_pattern`, `emi_mode`, `master_emi`, `master_emi_mode`, `direct_commission_to_agent`, `emi_commission_to_agent`, `down_payment_submitted`, `sales_date`, `no_of_master_emi`) VALUES
(1, 1, 0, 5, 300, 'Sales Policy 1', 50000, 110000, '6000x10;', 'Monthly', 18000, 'Yearly', '1000', '20', 0, '0000-00-00 00:00:00', 2);
