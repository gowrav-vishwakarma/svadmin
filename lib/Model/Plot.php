...
class Model_Plot extends Model_Table {
	...
	function sale_direct($customer,$unitrate,$salespolicy,$downpayment,$totalcost,$emipattern,$emimode,$emistartdate,$masteremi,$masteremimode,$directcommission,$emicommission){
